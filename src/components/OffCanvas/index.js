...
class OffCanvas extends React.Component {
    ...
    onTouchEnd() {
        if (this.isTouching()) {
            ...
            if (
                (this.props.show && percentage < 100 - this.props.dragToggleDistance)
                || (!this.props.show && percentage > this.props.dragToggleDistance)
            ) {
    ...
    render() {
        ...
        const classes = classNames('offcanvas offcanvas-start sidebar-nav bg-dark', this.props.show ? 'show' : '');
